class Indicators():
    ...
    @staticmethod
    def atr(_high: list[float], _low: list[float], _close: list[float], _length: int = 14, _array: int = 0):
        """
        ...
        Args:
            ...
            _length (int, optional): The period length for the ATR calculation. Defaults to 14.
