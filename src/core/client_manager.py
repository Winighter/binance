...
class ClientManager:
    ...
    def get_key():
        ...
        with open(key_file, 'r') as f:
            ...
            test_access_key = lines[2].strip()
            test_secret_key = lines[3].strip()
    ...
    def initialize_clients(self) -> Tuple:
        try:
            ...
            trading_manager = FuturesTradingManager(binance_client)
            ...
            ws_manager = WebSocketThreadManager(
                ...
                kline_interval2=self.app_config.KLINE_INTERVAL2,
