...
class TradingEngine:
    ...
    def analysis_liquidity_grab(self, swing_points: List, showGrabLogger:bool = False) -> Tuple:
        ...
        short_signal: Tuple[OrderSignal, Decimal] = None, Decimal('0')
        long_signal: Tuple[OrderSignal, Decimal] = None, Decimal('0')
    ...
    def identify_liquidity(self, showSwingPoint:bool = False):
        ...
        long_grab, short_grab = self.analysis_liquidity_grab(swing_points)
