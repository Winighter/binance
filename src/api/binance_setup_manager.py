...
from ..config import *
from ..shared.msg import DiscordHandler
...
logger = DiscordHandler.get_logger("SETUP_MANAGER")
...
class BinanceSetupManager:
    ...
    def __init__(
        ...
        self.max_failures = CIRCUIT_BREAKER_MAX_FAILURES
        self.timeout_seconds = CIRCUIT_BREAKER_TIMEOUT_SECONDS
    ...
    def _setup_initial_state(self) -> tuple[List[Decimal], List[Decimal], List[Decimal], List[Decimal], Decimal]:
        ...
        try:
            ...
            return self.open_prices, self.high_prices, self.low_prices, self.close_prices, available_usdt
