...
class Binance:
    ...
    def __init__(self):
        ...
        self.market_data, self.trading_engine, self.ws_manager, self.kline_queue, self.user_queue = ClientManager.initialize_clients(self.symbol, interval_obj, self.leverage)
