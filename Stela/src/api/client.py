...
class BinanceClient:
    ...
    def futures_create_order(self, symbol:str, side:Side, positionSide:PositionSide, quantity:Decimal, price:Decimal):
        try:
            ...
            if check:
                return self._safe_api_call(self.client.futures_create_order, symbol=symbol,side=side.value, type='LIMIT', timeInForce='GTC', price=price, quantity=quantity, positionSide=positionSide.value)
    ...
    def futures_order_book(self, symbol:str, limit:int = 500) -> Tuple[Dict, Dict]:
