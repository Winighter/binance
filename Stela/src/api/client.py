...
class BinanceClient:
    ...
    def futures_create_order(self, symbol:str, side:Side, positionSide:PositionSide, quantity:Decimal, price:Decimal):
        return self._safe_api_call(self.client.futures_create_order, symbol=symbol,side=side.value, type='LIMIT', timeInForce='IOC', price=price, quantity=quantity, positionSide=positionSide.value)
