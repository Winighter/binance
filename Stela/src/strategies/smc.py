        ...
        for key in list(swing_low_dict.keys()):
            ...
            if value:
                ...
                if longSignalIndex not in list(long_signal.keys()):
                    ...
                    # logger.info(f"[{len(lows)-longSignalIndex}] | SL: {lows[value]} | Entry: {closes[longSignalIndex]}")
        ...
        for key in list(swing_high_dict.keys()):
            ...
            if value:
                ...
                if shortSignalIndex not in list(short_signal.keys()):
                    ...
                    # logger.info(f"[{len(lows)-shortSignalIndex}] | SL: {highs[value]} | Entry: {closes[shortSignalIndex]}")
