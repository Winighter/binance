    ...
    def identify_points_of_interest(self, swing_range, highs, lows, closes, showLog:bool = False, lookback:int = 2):
        ...
        if showLog:
            for poi_side, poi_index, poi_miti_index, poi_invalid_idx, pd_price in POIs2:
                logger.info(f"[{poi_side}] {tl-poi_index} {poi_miti_index} {tl-poi_invalid_idx} {pd_price}")
            ...
            for i in range(poi_mitigated_ltf_index + 1, tl):
                ...
                if is_session:
                    ...
                    if poi_side == 'DEMAND' and close > poi_high:
                        long_data = (PositionSide.LONG, i, close, None, None)
                    ...
                    if poi_side == 'SUPPLY' and close < poi_low:
                        short_data = (PositionSide.SHORT, i, close, None, None)
