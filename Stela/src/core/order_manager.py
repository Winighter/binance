...
class OrderManager:
    ...
    def create_algo_exit_order(self, symbol:str, positionSide:PositionSide, type:AlgoOrderType, amount:Decimal, triggerPrice:Decimal) -> str:
        ...
        try:
            ...
            algoId = Decimal(str(order.get('algoId')))
            return algoId
        except Exception as e:
    ...
    def create_buy_position(self, position:PositionSide, quantity: Decimal, entry_price: Decimal, sl_price: Decimal, tp_price: Decimal):
