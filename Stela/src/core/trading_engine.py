        ...
        try:
            ...
            match user_event:
                ...
                case UserEventType.ACCOUNT_UPDATE.value:
                    ...
                    self.market_data.update_balance(showLog=True)
                    self.market_data.update_position(showLog=False)
                    '''
                    {
                ...
                #     data_ac = user_data.get('ac',None)
                #     symbol = data_ac.get('s',None)
                #     leverage = data_ac.get('l',None)

                #     # if data_ac and symbol and leverage:
                #     #     logger.info(f'Updated Symbol: {symbol} | Leverage: {leverage}')
