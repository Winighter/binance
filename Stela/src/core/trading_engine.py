...
class TradingEngine:
    ...
    def get_position_quantity(self, position:PositionSide, price: Decimal, stop_loss_price: Decimal):
        ...
        try:
            logger.info(f"get_position_quantity: {self.balances.balance} {self.balances.available_balance}")
        ...
        try:
            ...
            match user_event:
                ...
                case UserDataEventType.ACCOUNT_UPDATE.value:
                    ...
                    logger.info(f"[TEST-ACCOUNT_UPDATE] {user_data}")
                            ...
                            match position_side:
                                ...
                                case PositionSide.LONG.value:
                                    if position_amount:  # 0이 아닐 때 (True)
                                        ...
                                        logger.info(f"[LONG-ACCount] entry: {entry_price} | pa: {position_amount}")
