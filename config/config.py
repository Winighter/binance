...
# STOP LOSS
ENABLE_STOP_LOSS = True # STOP LOSS
ENABLE_SL_ST_BOTH = True # n2 and st_value
ENABLE_SL_ST_ONLY = False # no n2 yest st_value
...
# Stop Loss (Required)
ATR_MULTIPLIER = 2.0 # 높을경우 손절확률은 낮고 손실금액이 높음, 낮으면 그반대 (최소 1.0 이상)
